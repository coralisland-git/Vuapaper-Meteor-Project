  ...
  setTimeout(function(){
    ...
    var handle = cursor.observe({
      added:function(fields){
        ...
        var aname = fields.type == 0 ? '<p class="rvrtx-name" style="color:red;float:right;">Osama</p>' : '';
        ...
        Tracker.afterFlush(function () {
          $('.rvrtx-msg_container_base').animate({ scrollTop: $('.rvrtx-msg_container_base').prop('scrollHeight') }, 0);
            ...
            $('#rvrtx-msg-container').on('keypress keyup keydown', function(event) {
                console.log(event);
                //let chatContainer = $('#rvrtx-msg-container_base');
                //debugger;
...
function addChatBox(startLine, headLine) {
    boxstatus = 0;
    headLine = headLine == null ? 'Vuapaper Support' : headLine;
    startLine = startLine == null ? 'Hello! I am Osama, standing by to get your issues fixed and questions vanished! :)' : startLine;
    ...
    document.getElementById('rvrtx-chatbox').innerHTML =
        ...
        '<p class="rvrtx-name" style="color:red;float:right;">Osama</p>'+
        '<div class="rvrtx-talktext">'+
