import './order.html';
Template.order.onCreated(function helloOnCreated() {
...
Template.order.events({
  ...
  'click #paper-details-step-content .step-nav a.next': function(evt) {
    if($('#topic').val()!= '')
      ...
      notifyErr('Please type down topic');
  },
  ...
  'click #save': function(evt) {
    ...
    Meteor.call('insertOrder',
      Template.instance().selectedAcademic.get(),
      Template.instance().selectedType.get(),
      Template.instance().selectedSubject.get(),
      Template.instance().selectedTopic.get(),
      Template.instance().selectedInstructions.get(),
      Template.instance().selectedSource.get(),
      Template.instance().selectedFormat.get(),
      Template.instance().selectedCount.get(),
      Template.instance().selectedSpaced.get(),
      Template.instance().selectedDeadline.get(),
      Template.instance().selectedCategory.get(),
      Template.instance().selectedSlides.get(),
      Template.instance().selectedVIP.get(),
      Template.instance().selectedBest.get(),
      Template.instance().selectedPrice.get(),
      payment,
      function(err,res){
        if (!err) {
          notify('Order placed successfully, Please continue your payment');
